        ...
        self.table_headers = ft.Row(
            ...
            controls=[
                ...
                ft.Text("Proyecto", size=16, weight=ft.FontWeight.BOLD, color=ft.colors.BLACK, text_align="center", width=70),
                   ...
                   ft.Text("Domingo", size=16, weight=ft.FontWeight.BOLD, color=ft.colors.BLACK, text_align="center", width=100),
                   
                   ft.Text("Lunes", size=16, weight=ft.FontWeight.BOLD, color=ft.colors.BLACK, text_align="center", width=80),
                   ft.Text("Martes", size=16, weight=ft.FontWeight.BOLD, color=ft.colors.BLACK, text_align="center", width=80),
                   ft.Text("Miercoles", size=16, weight=ft.FontWeight.BOLD, color=ft.colors.BLACK, text_align="center", width=100),
                   ft.Text("Jueves", size=16, weight=ft.FontWeight.BOLD, color=ft.colors.BLACK, text_align="center", width=90),
                   ft.Text("Viernes", size=16, weight=ft.FontWeight.BOLD, color=ft.colors.BLACK, text_align="center", width=80),
                   ft.Text("Sabado", size=16, weight=ft.FontWeight.BOLD, color=ft.colors.BLACK, text_align="center", width=100),
                                                        ...
                                                        ft.Row(
                                                            controls=[
                                                                ...
                                                                *[ft.Column(
                                                                ...
                                                                ) for _ in range(14)],  # Generar 14 columnas
